    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('강아지', '강아지'), ('고양이', '고양이'), ('기타동물', '기타동물')], db_index=True, max_length=10, unique=True, verbose_name='품종')),
            ],
        ),
        migrations.CreateModel(
            name='Animal',
            fields=[
                ...
                ('category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='streetanimal.category', verbose_name='동물 종')),
            ],
            options={
                'abstract': False,
            },
